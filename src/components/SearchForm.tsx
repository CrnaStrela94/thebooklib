...
export const SearchForm = () => {
    ...
    return (
        <form onSubmit={(e: React.FormEvent<HTMLFormElement>) => handleSearch(e as unknown as { preventDefault: () => void; target: { search: { value: any; }; }; })} className="flex space-x-4 mb-6 mt-16">
            ...
            <Buttons text={'Search'} type={'submit'} onClick={() => { }} />
        </form>
    );
};